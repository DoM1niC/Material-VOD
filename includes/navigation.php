	...
	<a href="#" data-activates="slide" class="button-collapse"><i class="fa-white material-icons">menu</i></a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a class="h5-text" href="index.php?page=uploads"><i class="fa fa-white fa-file-video-o fa-1x" aria-hidden="true"></i>&nbsp; Hochgeladene Videos</a></li>
        <li><a class="hide" href="#stream"><i class="hide fa fa-white fa-video-camera fa-1x" aria-hidden="true"></i>&nbsp; Stream</a></li>
  ...
  <ul id='dropdown1' class='nav-drop dropdown-content'>
    	<li><a href="index.php?page=servamp#show">Servamp</a></li>
  </ul>
      </ul>
  <ul id='dropdown1' class='nav-drop dropdown-content'>
  </ul>
